...
//Patch by QNAP: support access by ioport
...
#ifdef CONFIG_MACH_QNAPTS
	superio_select(sioaddr, GPIO);
	gpio_addr = superio_inw(sioaddr, 0x62);
...
//Patch by QNAP: fix gpio
#ifdef CONFIG_MACH_QNAPTS
static int init_gpio(int sioaddr)
{
    int val, __maybe_unused i;

    superio_enter(sioaddr);
    superio_select(sioaddr, GPIO);

    //GP50 USB LED
    val = superio_inb(sioaddr, IT87_GPIO_SET5_SEL_REG);
    superio_outb(sioaddr, IT87_GPIO_SET5_SEL_REG, val | 0x01);	//select GPIO Set5 function
    val = superio_inb(sioaddr, IT87_GPIO_SET5_ENABLE_REG);
    superio_outb(sioaddr, IT87_GPIO_SET5_ENABLE_REG, val | 0x01);
    val = superio_inb(sioaddr, IT87_GPIO_SET5_OUTPUT_ENABLE_REG);
    superio_outb(sioaddr, IT87_GPIO_SET5_OUTPUT_ENABLE_REG, val | 0x01);

    //button detect
    //GP16 GP17
    val = superio_inb(sioaddr, IT87_GPIO_SET1_SEL_REG);
    superio_outb(sioaddr, IT87_GPIO_SET1_SEL_REG, val | 0xc0);	//select GPIO Set1 function
    val = superio_inb(sioaddr, IT87_GPIO_SET1_ENABLE_REG);
    superio_outb(sioaddr, IT87_GPIO_SET1_ENABLE_REG, val | 0xc0);	//enable simple IO function
    val = superio_inb(sioaddr, IT87_GPIO_SET1_OUTPUT_ENABLE_REG);
    superio_outb(sioaddr, IT87_GPIO_SET1_OUTPUT_ENABLE_REG, val & 0x3f);
